...
public class VectorImpl_DataSource_Throwable_long_
  implements Vector_Throwable_long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_Throwable_long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_Throwable_long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_Throwable_long_(context, vector_source);
    }

    public Throwable get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Throwable) vector_source.get(context).elementAt((int) index);
    ...
    public Throwable set          (CallContext context, long index, Throwable item) {
        ...
        return (Throwable) vector_source.get(context).set((int) index, item);
    }
    ...
    public Throwable unset        (CallContext context, long index) {
        try {
            return (Throwable) vector_source.get(context).remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
