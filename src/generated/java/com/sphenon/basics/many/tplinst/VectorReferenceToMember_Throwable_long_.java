...
public class VectorReferenceToMember_Throwable_long_
    implements ReferenceToMember_Throwable_long_ReadOnlyVector_Throwable_long__
{
    private ReadOnlyVector_Throwable_long_ vector;
    private long                          index;

    public VectorReferenceToMember_Throwable_long_ (CallContext context, ReadOnlyVector_Throwable_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public ReadOnlyVector_Throwable_long_ getContainer (CallContext context) {
        return this.vector;
    }
    ...
    public Throwable get (CallContext context) {
            try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_Throwable_long_)) return false;
        if (((VectorReferenceToMember_Throwable_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_Throwable_long_) object).index  != this.index ) return false;
        return true;
    }
