...
public class MapReferenceToMember_File_String_
    implements ReferenceToMember_File_String_Map_File_String__
{
    private Map_File_String_    map;
    private String                  index;

    public MapReferenceToMember_File_String_ (CallContext context, Map_File_String_ map, String index) {
        this.map    = map;
        this.index  = index;
    ...
    public Map_File_String_ getContainer (CallContext context) {
        return this.map;
    }
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof MapReferenceToMember_File_String_)) return false;
        if (((MapReferenceToMember_File_String_) object).map != this.map) return false;
        if (((MapReferenceToMember_File_String_) object).index  != this.index ) return false;
        return true;
    }
