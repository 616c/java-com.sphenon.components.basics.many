...
public class VectorReferenceToMember_Vector_String_long__long_
    implements ReferenceToMember_Vector_String_long__long_ReadOnlyVector_Vector_String_long__long__
{
    private ReadOnlyVector_Vector_String_long__long_ vector;
    private long                          index;

    public VectorReferenceToMember_Vector_String_long__long_ (CallContext context, ReadOnlyVector_Vector_String_long__long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public ReadOnlyVector_Vector_String_long__long_ getContainer (CallContext context) {
        return this.vector;
    }
    ...
    public Vector_String_long_ get (CallContext context) {
            try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_Vector_String_long__long_)) return false;
        if (((VectorReferenceToMember_Vector_String_long__long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_Vector_String_long__long_) object).index  != this.index ) return false;
        return true;
    }
