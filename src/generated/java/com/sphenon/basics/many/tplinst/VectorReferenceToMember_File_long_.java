...
public class VectorReferenceToMember_File_long_
    implements ReferenceToMember_File_long_ReadOnlyVector_File_long__
{
    private ReadOnlyVector_File_long_ vector;
    private long                          index;

    public VectorReferenceToMember_File_long_ (CallContext context, ReadOnlyVector_File_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_File_long_)) return false;
        if (((VectorReferenceToMember_File_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_File_long_) object).index  != this.index ) return false;
        return true;
    }
