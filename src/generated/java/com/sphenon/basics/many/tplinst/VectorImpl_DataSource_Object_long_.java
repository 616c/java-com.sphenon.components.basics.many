...
public class VectorImpl_DataSource_Object_long_
  implements Vector_Object_long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_Object_long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_Object_long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_Object_long_(context, vector_source);
    }

    public Object get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Object) vector_source.get(context).elementAt((int) index);
    ...
    public Object set          (CallContext context, long index, Object item) {
        ...
        return (Object) vector_source.get(context).set((int) index, item);
    }
    ...
    public Object unset        (CallContext context, long index) {
        try {
            return (Object) vector_source.get(context).remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
