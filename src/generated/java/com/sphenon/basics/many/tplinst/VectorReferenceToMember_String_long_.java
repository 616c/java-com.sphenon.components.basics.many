...
public class VectorReferenceToMember_String_long_
    implements ReferenceToMember_String_long_ReadOnlyVector_String_long__
{
    private ReadOnlyVector_String_long_ vector;
    private long                          index;

    public VectorReferenceToMember_String_long_ (CallContext context, ReadOnlyVector_String_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public ReadOnlyVector_String_long_ getContainer (CallContext context) {
        return this.vector;
    }
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_String_long_)) return false;
        if (((VectorReferenceToMember_String_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_String_long_) object).index  != this.index ) return false;
        return true;
    }
