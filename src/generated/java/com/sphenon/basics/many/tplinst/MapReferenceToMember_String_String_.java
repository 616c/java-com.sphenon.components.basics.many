...
public class MapReferenceToMember_String_String_
    implements ReferenceToMember_String_String_Map_String_String__
{
    private Map_String_String_    map;
    private String                  index;

    public MapReferenceToMember_String_String_ (CallContext context, Map_String_String_ map, String index) {
        this.map    = map;
        this.index  = index;
    ...
    public Map_String_String_ getContainer (CallContext context) {
        return this.map;
    }
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof MapReferenceToMember_String_String_)) return false;
        if (((MapReferenceToMember_String_String_) object).map != this.map) return false;
        if (((MapReferenceToMember_String_String_) object).index  != this.index ) return false;
        return true;
    }
