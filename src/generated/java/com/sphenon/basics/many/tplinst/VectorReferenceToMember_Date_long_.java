...
public class VectorReferenceToMember_Date_long_
    implements ReferenceToMember_Date_long_ReadOnlyVector_Date_long__
{
    private ReadOnlyVector_Date_long_ vector;
    private long                          index;

    public VectorReferenceToMember_Date_long_ (CallContext context, ReadOnlyVector_Date_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_Date_long_)) return false;
        if (((VectorReferenceToMember_Date_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_Date_long_) object).index  != this.index ) return false;
        return true;
    }
