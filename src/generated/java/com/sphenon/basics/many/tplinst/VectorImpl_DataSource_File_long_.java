...
public class VectorImpl_DataSource_File_long_
  implements Vector_File_long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_File_long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_File_long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_File_long_(context, vector_source);
    }

    public File get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (File) vector_source.get(context).elementAt((int) index);
    ...
    public File set          (CallContext context, long index, File item) {
        ...
        return (File) vector_source.get(context).set((int) index, item);
    }
    ...
    public File unset        (CallContext context, long index) {
        try {
            return (File) vector_source.get(context).remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
