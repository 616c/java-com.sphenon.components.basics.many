...
public class VectorIteratorImpl_String_long_
    implements IteratorItemIndex_String_long_,
               Cloneable
{
    private ReadOnlyVector_String_long_ vector;
    private long current_index;

    public VectorIteratorImpl_String_long_ (CallContext context, ReadOnlyVector_String_long_ vector) {
        this.vector = vector;
    ...
    public VectorIteratorImpl_String_long_ clone(CallContext context) {
        try {
            return (VectorIteratorImpl_String_long_) super.clone();
