...
public class VectorReferenceToMember_Object_long_
    implements ReferenceToMember_Object_long_ReadOnlyVector_Object_long__
{
    private ReadOnlyVector_Object_long_ vector;
    private long                          index;

    public VectorReferenceToMember_Object_long_ (CallContext context, ReadOnlyVector_Object_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_Object_long_)) return false;
        if (((VectorReferenceToMember_Object_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_Object_long_) object).index  != this.index ) return false;
        return true;
    }
