...
public class MapReferenceToMember_Long_String_
    implements ReferenceToMember_Long_String_Map_Long_String__
{
    private Map_Long_String_    map;
    private String                  index;

    public MapReferenceToMember_Long_String_ (CallContext context, Map_Long_String_ map, String index) {
        this.map    = map;
        this.index  = index;
    ...
    public Map_Long_String_ getContainer (CallContext context) {
        return this.map;
    }
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof MapReferenceToMember_Long_String_)) return false;
        if (((MapReferenceToMember_Long_String_) object).map != this.map) return false;
        if (((MapReferenceToMember_Long_String_) object).index  != this.index ) return false;
        return true;
    }
