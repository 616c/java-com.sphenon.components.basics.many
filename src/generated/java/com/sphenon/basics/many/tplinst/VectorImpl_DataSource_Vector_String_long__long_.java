...
public class VectorImpl_DataSource_Vector_String_long__long_
  implements Vector_Vector_String_long__long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_Vector_String_long__long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_Vector_String_long__long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_Vector_String_long__long_(context, vector_source);
    }

    public Vector_String_long_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Vector_String_long_) vector_source.get(context).elementAt((int) index);
    ...
    public Vector_String_long_ set          (CallContext context, long index, Vector_String_long_ item) {
        ...
        return (Vector_String_long_) vector_source.get(context).set((int) index, item);
    }
    ...
    public Vector_String_long_ unset        (CallContext context, long index) {
        try {
            return (Vector_String_long_) vector_source.get(context).remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
