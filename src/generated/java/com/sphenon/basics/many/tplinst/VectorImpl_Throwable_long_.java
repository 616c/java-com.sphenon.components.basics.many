...
public class VectorImpl_Throwable_long_
  implements Vector_Throwable_long_,
             VectorOptimized<Throwable>,
             Dumpable,
             ManagedResource
 {
    private java.util.Vector vector;

    protected VectorImpl_Throwable_long_ (CallContext context) {
        vector = new java.util.Vector(4);
    }

    static public VectorImpl_Throwable_long_ create (CallContext context) {
        return new VectorImpl_Throwable_long_(context);
    }

    protected VectorImpl_Throwable_long_ (CallContext context, java.util.Vector vector) {
        this.vector = vector;
    }

    static public VectorImpl_Throwable_long_ create (CallContext context, java.util.Vector vector) {
        return new VectorImpl_Throwable_long_(context, vector);
    }
    ...
    public Throwable get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Throwable) vector.elementAt((int) index);
    ...
    public VectorReferenceToMember_Throwable_long_ getReference    (CallContext context, long index) throws DoesNotExist {
        ...
        return new VectorReferenceToMember_Throwable_long_(context, this, index);
    }
    ...
    public Throwable set          (CallContext context, long index, Throwable item) {
        ...
        return (Throwable) vector.set((int) index, item);
    }
    ...
    public void     prepend      (CallContext call_context, Throwable item) {
        if (vector.size() == 0) {
            vector.add(item);
        } else {
            try {
    ...
    public Throwable replace      (CallContext call_context, long index, Throwable item) throws DoesNotExist {
        try {
            return (Throwable) vector.set((int) index, item);
        } catch (ArrayIndexOutOfBoundsException e) {
    ...
    public Throwable unset        (CallContext context, long index) {
        try {
            return (Throwable) vector.remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
    ...
    public boolean contains(CallContext context, Throwable item) {
        return this.vector.contains(item);
    }

    public boolean removeFirst(CallContext context, Throwable item) {
        return this.vector.remove(item);
    }

    public void removeAll(CallContext context, Throwable item, VectorOptimized.Notifier<Throwable> notifier) {
