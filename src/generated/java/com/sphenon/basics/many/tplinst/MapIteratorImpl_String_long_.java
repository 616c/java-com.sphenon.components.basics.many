...
public class MapIteratorImpl_String_long_
    implements IteratorItemIndex_String_long_
{
    private Map_String_long_ map_t;
    private java.util.Hashtable map;
    private java.util.Set entry_set;
    private java.util.Iterator iterator;
    private java.util.Map.Entry me;

    public MapIteratorImpl_String_long_ (CallContext context, java.util.Hashtable map, Map_String_long_ map_t) {
        this.map_t = map_t;
        this.map = map;
    ...
    public MapIteratorImpl_String_long_ clone(CallContext context) {
