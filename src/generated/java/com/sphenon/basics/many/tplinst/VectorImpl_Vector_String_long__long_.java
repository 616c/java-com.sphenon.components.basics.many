...
public class VectorImpl_Vector_String_long__long_
  implements Vector_Vector_String_long__long_,
             VectorOptimized<Vector_String_long_>,
             Dumpable,
             ManagedResource
 {
    private java.util.Vector vector;

    protected VectorImpl_Vector_String_long__long_ (CallContext context) {
        vector = new java.util.Vector(4);
    }

    static public VectorImpl_Vector_String_long__long_ create (CallContext context) {
        return new VectorImpl_Vector_String_long__long_(context);
    }

    protected VectorImpl_Vector_String_long__long_ (CallContext context, java.util.Vector vector) {
        this.vector = vector;
    }

    static public VectorImpl_Vector_String_long__long_ create (CallContext context, java.util.Vector vector) {
        return new VectorImpl_Vector_String_long__long_(context, vector);
    }
    ...
    public Vector_String_long_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Vector_String_long_) vector.elementAt((int) index);
    ...
    public VectorReferenceToMember_Vector_String_long__long_ getReference    (CallContext context, long index) throws DoesNotExist {
        ...
        return new VectorReferenceToMember_Vector_String_long__long_(context, this, index);
    }
    ...
    public Vector_String_long_ set          (CallContext context, long index, Vector_String_long_ item) {
        ...
        return (Vector_String_long_) vector.set((int) index, item);
    }
    ...
    public void     prepend      (CallContext call_context, Vector_String_long_ item) {
        if (vector.size() == 0) {
            vector.add(item);
        } else {
            try {
    ...
    public Vector_String_long_ replace      (CallContext call_context, long index, Vector_String_long_ item) throws DoesNotExist {
        try {
            return (Vector_String_long_) vector.set((int) index, item);
        } catch (ArrayIndexOutOfBoundsException e) {
    ...
    public Vector_String_long_ unset        (CallContext context, long index) {
        try {
            return (Vector_String_long_) vector.remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
    ...
    public boolean contains(CallContext context, Vector_String_long_ item) {
        return this.vector.contains(item);
    }

    public boolean removeFirst(CallContext context, Vector_String_long_ item) {
        return this.vector.remove(item);
    }

    public void removeAll(CallContext context, Vector_String_long_ item, VectorOptimized.Notifier<Vector_String_long_> notifier) {
