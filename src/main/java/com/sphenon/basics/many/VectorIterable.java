...
public class VectorIterable<T>
    implements Iterable<T>,
    Anchorable
{
    protected java.util.Iterator<T> iterator;

    public VectorIterable(CallContext context, GenericIterable<T> gi) {
        this.iterator = (gi == null ? (new java.util.Vector<T>()).iterator() : gi.getIterator(context));
    }
